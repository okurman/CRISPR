...
class Locus(object):
    ...
    def __init__(self, file_name, annotation_map=None):
        ...
        _genes = dt.get_pty_file_generic(file_name, annotation_map=annotation_map)
        self.genes = _genes
...
def plot_dendrogram(Z, dendogram_file_name):
    ...
    plt.savefig(os.path.join(report_path, dendogram_file_name), format='pdf')
